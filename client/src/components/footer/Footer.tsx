const Footer = () => {
  return (
    <div>
      <footer className="bg-white/50 dark:bg-neutral-950/50 text-gray-700 dark:text-gray-300 py-10 mt-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              <svg
                ...
                height="30"
                viewBox="0 0 50 50"
                className="fill-current dark:text-gray-300"
              >
            ...
            <a
              href="https://facebook.com/sahabulislamsifat"
              title="Facebook"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-600 dark:text-gray-300 hover:text-purple-600 transition"
